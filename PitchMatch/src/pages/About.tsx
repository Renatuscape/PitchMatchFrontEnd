        ...
        <Container maxWidth='sm' sx={{ backgroundColor: 'white', padding: 2, display: 'flex', alignItems: 'flex-end' }}>
            <div>
                ...
                <p>
                    ...
                    As soon as we started pitching ideas for our graduation project, we realised that the major thing we have in common is that we want to foster good, lasting relationships.
